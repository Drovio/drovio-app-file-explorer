...
{
	// Get menu item
	$mItem = HTML::select(".fileExplorerApplication .sidebar .menuitem.".$class)->item(0);
	
	// Set navigation ref
	$appContent->setStaticNav($mItem, $ref = "", $targetcontainer = "", $targetgroup = "", $navgroup = "fxnavgroup", $display = "none");
	
	// Set action
	$actionFactory->setAction($mItem, $viewName, ".fileExplorerApplication .mainContent", "replace");
}
