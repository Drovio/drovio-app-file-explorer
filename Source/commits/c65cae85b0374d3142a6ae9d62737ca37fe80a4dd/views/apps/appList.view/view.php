...
{
	// Build the app box
	$appBox = buildAppBox($appInfo['application_id'], $appInfo, $actionFactory);
...
if ($isDev)
{
	...
	{
		// Build the app box
		$appBox = buildAppBox($appInfo['id'], $appInfo, $actionFactory);
		DOM::append($appList, $appBox);
	}
}
...
function buildAppBox($applicationID, $appInfo, $actionFactory)
{
